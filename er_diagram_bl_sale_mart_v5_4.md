...
erDiagram
    ...
    WK_RSLT_UPD ||--o{ V_COR_ORDR_HDR : "busn_cd, cust_no, ord_no"
    WK_RSLT_UPD ||--o{ V_COR_ORDR_DTLS : "busn_cd, cust_no, ord_no, ord_line_no"
    
    %% V_COR_ORDR_DTLS(G)を起点とした関連
    V_COR_ORDR_DTLS ||--o{ V_COR_REQ_DTLS : "busn_cd, cust_no, ord_no, ord_line_no"
    
    %% V_COR_REQ_DTLS(K)を起点とした関連
    V_COR_REQ_DTLS ||--o{ V_COR_REQ_HDR : "busn_cd, cust_no, ord_no"
    
    %% V_COR_REQ_HDR(L)を起点とした関連
    V_COR_REQ_HDR ||--o{ V_COR_CUST_DEPO_HIST : "busn_cd, cust_no, ord_no"
...
erDiagram
    ...
    V_COR_EXCD_GODS ||--o{ V_COR_PRM_GODS_S1_BBOB : "busn_cd, new_prm_gods"
    V_COR_EXCD_GODS ||--o{ V_COR_OL_GODS_DTLS : "busn_cd, new_prm_gods"
    
    %% V_COR_PRM_GODS_S1_BBOB(B)を起点とした関連
    V_COR_PRM_GODS_S1_BBOB ||--o{ V_COR_PRM_GODS : "busn_cd, prm_cd, new_prm_gods"
    V_COR_PRM_GODS_S1_BBOB ||--o{ V_COR_GODS : "busn_cd, gods_cd, gods_srno"
    V_COR_PRM_GODS_S1_BBOB ||--o{ V_COR_GODS_ANLY : "busn_cd, gods_cd, gods_srno"
    V_COR_PRM_GODS_S1_BBOB ||--o{ V_COR_GODS_S1_BBOB : "busn_cd, gods_cd, gods_srno"
    V_COR_PRM_GODS_S1_BBOB ||--o{ V_COR_GODS_S2_BB : "busn_cd, gods_cd, gods_srno"
    
    %% V_COR_OL_GODS_DTLS(J)を起点とした関連
    V_COR_OL_GODS_DTLS ||--o{ V_COR_OL_GODS : "busn_cd, cata_no, ec_gods_no"
    
    %% RT_APRL_SIZEはV_COR_GODS_S1_BBOB経由で結合
    V_COR_GODS_S1_BBOB ||--o{ RT_APRL_SIZE : "size_cd"
    
    %% 最終的にWK_RT_GODSへINSERT（V_COR_EXCD_GODSが起点）
    V_COR_EXCD_GODS ||--|| WK_RT_GODS : "INSERT INTO"
```
...
erDiagram
    ...
    V_COR_EXCD ||--o{ V_COR_PRM : "busn_cd, prm_cd"
    
    %% V_COR_PRM(B)を起点とした関連
    V_COR_PRM ||--o{ V_COR_MDIA : "busn_cd, mdia_cd"
    V_COR_PRM ||--o{ V_COR_PRM_S1_BBOB : "busn_cd, prm_cd"
    
    %% V_COR_MDIA(A)を起点とした関連
    V_COR_MDIA ||--o{ V_COR_MDIA_S1_BBOB : "busn_cd, mdia_cd"
    
    %% 最終的にWK_RT_MDIAへINSERT（V_COR_EXCDが起点）
    V_COR_EXCD ||--|| WK_RT_MDIA : "INSERT INTO"

    %% ソーステーブル間の関連付け（MRT_WK_EC_100.sqlのJOIN構造に基づく）
    %% V_COR_CUST_WEB_PRPY(B)がメインテーブル
    V_COR_CUST_WEB_PRPY ||--o{ V_COR_MMBR_EC : "busn_cd, web_mmbr_no"
    
    %% 最終的にWK_RT_EC_MMBRへINSERT（V_COR_CUST_WEB_PRPYが起点）
    V_COR_CUST_WEB_PRPY ||--|| WK_RT_EC_MMBR : "INSERT INTO"
```
...
erDiagram
    ...
    V_COR_ORDR_DTLS_S1_GB ||--o{ V_COR_ORDR_HDR_S1_GB : "busn_cd, cust_no, ord_no"
    V_COR_ORDR_DTLS_S1_GB ||--o{ V_COR_ORDR_DTLS : "busn_cd, cust_no, ord_no, ord_line_no"
    
    %% V_COR_ORDR_HDR_S1_GB(B)を起点とした関連
    V_COR_ORDR_HDR_S1_GB ||--o{ V_COR_REQ_HDR : "busn_cd, cust_no, ord_no"
    
    %% 最終的にWK_HANPU_DTLSへINSERT（V_COR_ORDR_DTLS_S1_GBが起点）
    V_COR_ORDR_DTLS_S1_GB ||--|| WK_HANPU_DTLS : "INSERT INTO"

    %% ソーステーブル間の関連付け（MRT_WK_PRID_100.sqlのJOIN構造に基づく）
    %% V_COR_ORDR_DTLS_S2_OB(A)がメインテーブル
    V_COR_ORDR_DTLS_S2_OB ||--o{ V_COR_ORDR_HDR_S2_OB : "busn_cd, cust_no, ord_no"
    V_COR_ORDR_DTLS_S2_OB ||--o{ V_COR_ORDR_DTLS : "busn_cd, cust_no, ord_no, ord_line_no"
    V_COR_ORDR_DTLS_S2_OB ||--o{ V_COR_PRID_ORDR_INFO : "busn_cd, cust_no, ord_no"
    
    %% 最終的にWK_RT_PRID_DTLSへINSERT（V_COR_ORDR_DTLS_S2_OBが起点）
    V_COR_ORDR_DTLS_S2_OB ||--|| WK_RT_PRID_DTLS : "INSERT INTO"
```
