...
erDiagram
    ...
    %% ========================================
    %% Tier2 販売分析系ソース（WK_SALE_ANLYの元テーブル）
    %% ========================================
    V_COR_ORDR_HDR {
        DECIMAL busn_cd PK "事業コード"
        DECIMAL cust_no PK "顧客番号"
        DECIMAL ord_no PK "受注番号"
        VARCHAR ordr_rout "受注経路"
    }
    ...
    %% ========================================
    %% Tier2 マスタ系ソース（WK_RT_GODSの元テーブル）
    %% ========================================
    V_COR_GODS {
        DECIMAL busn_cd PK "事業コード"
    ...
    %% ========================================
    %% Tier2 マスタ系ソース（WK_RT_MDIAの元テーブル）
    %% ========================================
    V_COR_MDIA {
        DECIMAL busn_cd PK "事業コード"
    ...
    %% ========================================
    %% Tier2 詳細系ソース（WK_HANPU_DTLSの元テーブル）
    %% ========================================
    ...
    %% ========================================
    %% Tier2 詳細系ソース（WK_RT_PRID_DTLSの元テーブル）
    %% ========================================
