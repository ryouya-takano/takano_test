...
erDiagram
    ...
    V_COR_ORDR_HDR_S1_GB_受注ヘッダ_グルメ頒布会用 ||--|| V_COR_REQ_HDR_依頼ヘッダ : "busn_cd, cust_no, ord_no"
    ...
    V_COR_ORDR_HDR_S2_OB_受注ヘッダ_オージオ定期用 }o--|| V_COR_ORDR_DTLS_S2_OB_受注明細_オージオ定期用 : "busn_cd, cust_no, ord_no"
    V_COR_ORDR_DTLS_受注明細 ||--|| V_COR_ORDR_DTLS_S2_OB_受注明細_オージオ定期用 : "busn_cd, cust_no, ord_no, ord_line_no"
...
erDiagram
    ...
    %% RT_SALE_ANLYからの関係
    RT_SALE_ANLY ||--|| ACS_ITGT_CUST_DTLS : "itgt_cust_id, busn_cd, cust_no"
